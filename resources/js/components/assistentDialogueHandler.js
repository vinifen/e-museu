import { getCurrentPageDialogues } from '../assistant/dialogues.js';

export function initAssistentDialogueHandler() {
    $(document).ready(function() {
        const dialogues = getCurrentPageDialogues();
        ...
        // Iniciar sempre com o primeiro diálogo
        displayDialogue(1);
    });
}
