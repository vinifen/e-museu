...
<div class="container main-container mb-auto">
    ...
    <div class="row">
        ...
        <div class="col-2 d-block d-md-none">
            <button class="btn btn-primary d-md-none toggle-filter-button-mobile py-2" type="button" data-bs-toggle="offcanvas" data-bs-target="#sidebar" aria-controls="sidebar">
            ...
            <div class="content row">
                @foreach($items as $item)
                    <div class="col pb-5 d-flex justify-content-center">
                        <a href={{ route('items.show', $item->id) }} class="card d-flex card-anim" style="width: 18rem; height: 28rem;">
                            <img src="{{ url("storage/{$item->image}") }}" class="card-img-top p-1" style="height: 12rem; object-fit: cover;" alt="Imagem do item">
                            <div class="card-body">
