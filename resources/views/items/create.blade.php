...
<div class="container main-container mb-auto">
    ...
    <div class="ms-4 mb-4">
        @foreach($errors->all() as $error)
            <p class="error-div text-wrap fw-bold m-1 p-1"><i class="bi bi-exclamation-circle-fill mx-1 h5"></i> {{ $error }}</p>
        @endforeach
        @if (session('success'))
        ...
        <div class="row">
            <div class="col-md-6">
                <div>
                    <label for="name">
                        <h5>Nome do Item
                            <button type="button" class="info-icon btn border-0 bg-transparent px-0 py-0 mb-1" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="focus" data-bs-content="O nome oficial do item, se disponível. Caso não tenha essa informação, um nome descritivo também é válido.">
                    ...
                    <div class="input-div">
                        <input
                            class="form-control me-2 input-form  @error('name') is-invalid @enderror"
                            type="text"
                            name="name"
                            id="name"
                            autocomplete="off"
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="input-div rounded-top">
                            <select required class="form-select me-2 input-form  @error('section') is-invalid @enderror" name="section_id" id="section_id">
                    ...
                    <div class="col-6">
                        <label for="date">
                            <h5>Data de Lançamento
                                <button type="button" class="info-icon btn border-0 bg-transparent px-0 py-0 mb-1" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="focus" data-bs-content="Data em que o item foi lançado e disponibilizado para uso.">
                                    <i class="bi bi-info-circle-fill h4 ms-1" style="color: #ED6E38; cursor: pointer;"></i>
                                </button>
                            </h5>
                        </label>
                        <div class="input-div">
                            <input
                                class="form-control me-2 input-form  @error('date') is-invalid @enderror"
                                type="date"
                                name="date"
                                placeholder=""
                                value="{{ old('date') }}"
                ...
                <div>
                    <label for="description">
                        <h5>Descrição Breve
                            <button type="button" class="info-icon btn border-0 bg-transparent px-0 py-0 mb-1" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="focus" data-bs-content="Forneça uma breve descrição do item, abordando sua função e funcionamento, se relevante.">
                                <i class="bi bi-info-circle-fill h4 ms-1" style="color: #ED6E38; cursor: pointer;"></i>
                            </button>
                        </h5>
                    </label>
                    <div class="input-div">
                        <textarea class="form-control me-2 input-form  @error('description') is-invalid @enderror"
                            type="text"
                            name="description"
                            placeholder=""
                            rows="6"
                ...
                <div>
                    <label for="detail">
                        <h5>Descrição Breve
                            <button type="button" class="info-icon btn border-0 bg-transparent px-0 py-0 mb-1" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="focus" data-bs-content="Por favor, forneça detalhes técnicos mais aprofundados sobre o item a ser cadastrado, incluindo informações sobre sua aparência física e outras características técnicas relevantes.">
                                <i class="bi bi-info-circle-fill h4 ms-1" style="color: #ED6E38; cursor: pointer;"></i>
                            </button>
                        </h5>
                    </label>
                    <div class="input-div">
                        <textarea
                            class="form-control me-2 input-form  @error('detail') is-invalid @enderror"
                            type="text"
                            name="detail"
                            placeholder=""
                            rows="6"
                ...
                <div>
                    <label for="history">
                        <h5>História
                            <button type="button" class="info-icon btn border-0 bg-transparent px-0 py-0 mb-1" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="focus" data-bs-content="Gostaríamos de conhecer a história por trás deste item. Quais foram os motivos ou circunstâncias que levaram à sua criação?">
                                <i class="bi bi-info-circle-fill h4 ms-1" style="color: #ED6E38; cursor: pointer;"></i>
                            </button>
                        </h5>
                    </label>
                    <div class="input-div">
                        <textarea
                            class="form-control me-2 input-form  @error('history') is-invalid @enderror"
                            type="text"
                            name="history"
                            placeholder=""
                            rows="24"
                ...
                <div>
                    <label for="image">
                        <h5>Imagem
                            <button type="button" class="info-icon btn border-0 bg-transparent px-0 py-0 mb-1" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="focus" data-bs-content="Uma imagem do item, nítida e representativa do item sendo cadastrado.">
                                <i class="bi bi-info-circle-fill h4 ms-1" style="color: #ED6E38; cursor: pointer;"></i>
                            </button>
                        </h5>
                    </label>
            ...
            <div class="col-md-6">
                <div>
                    <div class="d-flex justify-content-between">
                        <h5>Etiquetas
                            <button type="button" class="info-icon btn border-0 bg-transparent px-0 py-0 mb-1" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="focus" data-bs-content="As etiquetas servem para identificarmos com mais facilidade o seu item. Marca, tamanho e série são alguns dos exemplos de etiquetas disponíveis.">
                                <i class="bi bi-info-circle-fill h4 ms-1" style="color: #ED6E38; cursor: pointer;"></i>
                            </button>
                        </h5>
                    ...
                    <div class="tagContainer mb-4">
                        <div class="tags ms-3" id="tags">
                            <p class="text-center p-1 empty-text" id="tag-empty-text">Este item ainda não apresenta etiquetas.</p>
                        </div>
                ...
                <div>
                    <div class="d-flex justify-content-between">
                        <h5>Curiosidades
                            <button type="button" class="info-icon btn border-0 bg-transparent px-0 py-0 mb-1" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="focus" data-bs-content="Possui alguma curiosidade sobre o item a ser cadastrado que gostaria de compartilhar?">
                                <i class="bi bi-info-circle-fill h4 ms-1" style="color: #ED6E38; cursor: pointer;"></i>
                            </button>
                        </h5>
                    ...
                    <div class="extraContainer mb-4">
                        <div class="extras ms-3" id="extras">
                            <p class="text-center p-1 empty-text" id="extra-empty-text">Este item ainda não apresenta curiosidades.</p>
                        </div>
                        <div class="d-flex justify-content-center mt-3">
                ...
                <div>
                    <div class="d-flex justify-content-between">
                        <h5>Componentes
                            <button type="button" class="info-icon btn border-0 bg-transparent px-0 py-0 mb-1" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="focus" data-bs-content="O item a ser cadastrado é composto por outros componentes? Se você tiver essa informação, por favor, sinta-se à vontade para nos informar.">
                                <i class="bi bi-info-circle-fill h4 ms-1" style="color: #ED6E38; cursor: pointer;"></i>
                            </button>
                        </h5>
                    ...
                    <div class="componentContainer mb-4">
                        <div class="components ms-3" id="components">
                            <p class="text-center p-1 empty-text" id="component-empty-text">Este item ainda não apresenta componentes.</p>
                        </div>
                        <div class="d-flex justify-content-center mt-3">
    ...
    <script type="text/javascript">
        ...
        $( document ).ready(function() {
            ...
            if (sessionStorage.getItem("itemCreateForm") === null) {
                ...
                if (confirm("Deseja recuperar as etiquetas, curiosidades extras e componentes inseridos anteriormente?")) {
                    getSessionStorage();
                }
            }
            checkContact();
