                    ...
                    <label for="info">
                        <h5>Conteúdo
                            <button type="button" class="info-icon btn border-0 bg-transparent px-0 py-0 mb-1"
                                ...
                                data-bs-content="Está faltando alguma informação sobre esse item? Por favor, compartilhe esta informação conosco!">
                                <i class="bi bi-info-circle-fill h4 ms-1" style="color: #ED6E38; cursor: pointer;"></i>
                            </button>
                        </h5>
                    </label>
                    <div class="input-div rounded-top">
                        <textarea class="form-control me-2 input-form @error('content') is-invalid @enderror" type="text" name="content"
                            id="content" placeholder="" rows="30" required></textarea>
                    </div>
                    <div>
                        <label for="e-mail">
                            <h5>E-mail
                        ...
                        <div class="input-div">
                            <input class="form-control me-2 input-form  @error('contact') is-invalid @enderror"
                                type="email" name="contact" id="contribution-contact" placeholder=""
                                value="{{ old('contact') }}" onchange="checkContributionContact()"
                                onkeyup="checkContributionContact()" required>
                            @error('email')
                        ...
                        <div class="warning-div px-1 mx-5 mb-3" id="contribution-contact-warning" hidden>
                            <i class="bi bi-exclamation-circle-fill mx-1 h5"></i>Proprietário não encontrado!
                    ...
                    <div>
                        <label for="full_name">
                            <h5>Nome Completo
                                <button type="button" class="info-icon btn border-0 bg-transparent px-0 py-0 mb-1"
                                    data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="focus"
                                    data-bs-content="Por favor, informe seu nome completo. Precisamos dessas informações para que possamos creditá-lo quando esta informação for disponibilizada para exibição em nosso museu.">
                                    <i class="bi bi-info-circle-fill h4 ms-1"
                                        style="color: #ED6E38; cursor: pointer;"></i>
                                </button>
                            </h5>
                        ...
                        <div class="input-div">
                            <input class="form-control me-2 input-form  @error('full_name') is-invalid @enderror"
                                type="text" name="full_name" id="contribution-full_name" placeholder=""
