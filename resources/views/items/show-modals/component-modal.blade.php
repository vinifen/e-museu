            ...
            <div class="modal-body">
                <form action={{ route('items.store-component') }} method="POST" id="addComponentForm">
                    ...
                    <div class="input-div rounded-top">
                        <select class="form-select me-2 input-form" name="section_id" id="component-category"
                    ...
                    <div class="input-div rounded-top">
                        <input class="form-control typeahead me-2 input-form" type="text" name="component_name"
                            id="component-name" onchange="checkComponentName()" onkeyup="checkComponentName()"
                    ...
                    <div class="error-div px-1 mx-5 mb-3" id="component-name-warning" hidden>
                        ...
                        registros! O campo "Seção" e "nome" foram preenchidos corretamente?
                    </div>
                    <div class="col d-flex align-items-center justify-content-end">
                        <button class="button nav-link py-2 px-3 fw-bold" type="submit" id="save-component-button"
                            disabled>
                            Adicionar
                        </button>
                    </div>
