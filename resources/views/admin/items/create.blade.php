            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea type="text" class="form-control @error('detail') is-invalid @enderror" id="detail" name="detail" rows="7">{{ old('detail') }}</textarea>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('proprietary_id') is-invalid @enderror" id="proprietary_id" name="proprietary_id">
                                    ...
                                    <option value="{{ $proprietary->id }}" {{ old('proprietary_id') == $proprietary->id ? 'selected' : '' }}>{{ $proprietary->contact }} - {{ $proprietary->full_name }}</option>
                                    @endforeach
                                </select>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <textarea type="text" class="form-control @error('history') is-invalid @enderror" id="history" name="history" rows="46">{{ old('history') }}</textarea>
                        @error('history') <div class="invalid-feedback"> {{ $message }} </div> @enderror
                    </div>
                    <div class="mb-3">
                        <button type="submit" class="btn btn-success"><i class="bi bi-plus-circle"></i> Adicionar Item</button>
                    </div>
                </div>
            </div>
        </form>
