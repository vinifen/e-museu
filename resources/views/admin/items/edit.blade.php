            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea type="text" class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="5">{{ $item->description }}</textarea>
                        @error('description') <div class="invalid-feedback"> {{ $message }} </div> @enderror
                    </div>
                    <div class="mb-3">
                        <label for="detail" class="form-label">Detalhe</label>
                        <textarea type="text" class="form-control @error('detail') is-invalid @enderror" id="detail" name="detail" rows="7">{{ $item->detail }}</textarea>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('proprietary_id') is-invalid @enderror" id="proprietary_id" name="proprietary_id">
                                    ...
                                    <option value="{{ $proprietary->id }}" @if($item->proprietary_id == $proprietary->id) selected @endif>{{ $proprietary->contact }} - {{ $proprietary->full_name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control @error('date') is-invalid @enderror" id="date" name="date" value="{{ $item->date }}">
                                @error('date') <div class="invalid-feedback"> {{ $message }} </div> @enderror
                            </div>
                            <div class="mb-3">
                                <label for="identification_code" class="form-label">Código de Identificação</label>
                                <input type="text" class="form-control @error('identification_code') is-invalid @enderror" id="identification_code" name="identification_code" value="{{ $item->identification_code }}">
                                @error('identification_code') <div class="invalid-feedback"> {{ $message }} </div> @enderror
                            </div>
                            <div class="mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <img src="{{ url("storage/{$item->image}") }}" class="img-thumbnail clickable-image" alt="Imagem anterior do item">
                                <p>Imagem anterior</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <textarea type="text" class="form-control @error('history') is-invalid @enderror" id="history" name="history" rows="46">{{ $item->history }}</textarea>
