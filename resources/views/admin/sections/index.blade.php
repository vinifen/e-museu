    ...
    <div class="mb-auto container-fluid">
        ...
        <nav class="navbar navbar-light bg-light">
            <div class="container-fluid">
                <a href="{{ route('admin.sections.create') }}" type="button" class="btn btn-success"><i class="bi bi-plus-circle"></i> Adicionar Seção</a>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-center align-items-center">
                                    ...
                                    <a href="{{ route('admin.sections.edit', $section->id) }}" type="button" class="btn btn-warning me-1"><i class="bi bi-pencil-fill"></i></a>
                                    <form action="{{ route('admin.sections.destroy', $section->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-danger deleteSectionButton"><i class="bi bi-trash-fill"></i>
                                </form>
                                </div>
                            </td>
                            </tr>
