    ...
    <div class="mb-auto container-fluid">
        ...
        <nav class="navbar navbar-light bg-light">
            <div class="container-fluid">
                <a href="{{ route('admin.tags.create') }}" type="button" class="btn btn-success"><i class="bi bi-plus-circle"></i> Adicionar Etiqueta</a>
                    ...
                    <thead>
                        <form action="{{ route('admin.tags.index') }}" method="GET">
                            <tr>
                                ...
                                <th scope="col"><button class="btn border-0 bg-transparent px-0 py-0" type="submit" name="sort" value="category_id">Categoria</button></th>
                        ...
                        <tr class="@if(!$tag->locks->isEmpty() && $tag->locks->first()->user_id != auth()->user()->id) table-warning @endif">
                            ...
                            <td>
                                <div class="d-flex justify-content-center align-items-center">
                                    ...
                                    <a href="{{ route('admin.tags.edit', $tag->id) }}" type="button" class="btn btn-warning me-1"><i class="bi bi-pencil-fill"></i></a>
                                    <form action="{{ route('admin.tags.destroy', $tag->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-danger deleteTagButton"><i class="bi bi-trash-fill"></i>
                                </form>
                                </div>
                            </td>
                            </tr>
