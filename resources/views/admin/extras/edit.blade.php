            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea type="text" class="form-control @error('info') is-invalid @enderror" id="info" name="info" rows="5">{{ $extra->info }}</textarea>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('section_id') is-invalid @enderror" id="section_id" name="section_id">
                                    ...
                                    <option value="{{ $section->id }}" {{$extra->item->section->id == $section->id ? 'selected' : '' }}>{{ $section->name }}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('proprietary_id') is-invalid @enderror" id="proprietary_id" name="proprietary_id">
                            ...
                            <option value="{{ $proprietary->id }}" {{ $extra->proprietary->id == $proprietary->id ? 'selected' : '' }}>{{ $proprietary->contact }}</option>
                            @endforeach
                        </select>
