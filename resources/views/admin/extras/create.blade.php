            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea type="text" class="form-control @error('info') is-invalid @enderror" id="info" name="info" rows="5">{{ old('info') }}</textarea>
                    ...
                    <div class="mb-3">
                        <button type="submit" class="btn btn-success"><i class="bi bi-plus-circle"></i> Adicionar curiosidade Extra</button>
                    </div>
                </div>
            </div>
        </form>
