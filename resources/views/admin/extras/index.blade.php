    ...
    <div class="mb-auto container-fluid">
        ...
        <nav class="navbar navbar-light bg-light">
            <div class="container-fluid">
                <a href="{{ route('admin.extras.create') }}" type="button" class="btn btn-success"><i class="bi bi-plus-circle"></i> Adicionar Curiosidade Extra</a>
                    ...
                    <thead>
                        <form action="{{ route('admin.extras.index') }}" method="GET">
                            <tr>
                                ...
                                <th scope="col"><button class="btn border-0 bg-transparent px-0 py-0" type="submit" name="sort" value="info">Curiosidade</button></th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-center align-items-center">
                                    ...
                                    <a href="{{ route('admin.extras.edit', $extra->id) }}" type="button" class="btn btn-warning me-1"><i class="bi bi-pencil-fill"></i></a>
                                    <form action="{{ route('admin.extras.destroy', $extra->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-danger deleteExtraButton"><i class="bi bi-trash-fill"></i>
                                </form>
                                </div>
                            </td>
                            </tr>
