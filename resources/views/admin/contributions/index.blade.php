    ...
    <div class="mb-auto container-fluid">
        ...
        <nav class="navbar navbar-light bg-light">
            <div class="container-fluid">
                <a href="{{ route('admin.contributions.create') }}" type="button" class="btn btn-success"><i class="bi bi-plus-circle"></i> Adicionar Contribuição</a>
                    ...
                    <thead>
                        <form action="{{ route('admin.contributions.index') }}" method="GET">
                            <tr>
                                ...
                                <th scope="col"><button class="btn border-0 bg-transparent px-0 py-0" type="submit" name="sort" value="content">Conteúdo</button></th>
                                <th scope="col"><button class="btn border-0 bg-transparent px-0 py-0" type="submit" name="sort" value="item_id">Item</button></th>
                        ...
                        <tr class="@if(!$contribution->locks->isEmpty() && $contribution->locks->first()->user_id != auth()->user()->id) table-warning @endif">
                            ...
                            <td>
                                <div class="d-flex justify-content-center align-items-center">
                                    ...
                                    <a href="{{ route('admin.contributions.edit', $contribution->id) }}" type="button" class="btn btn-warning me-1"><i class="bi bi-pencil-fill"></i></a>
                                    <form action="{{ route('admin.contributions.destroy', $contribution->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-danger deleteContributionButton"><i class="bi bi-trash-fill"></i>
                                </form>
                                </div>
                            </td>
                            </tr>
