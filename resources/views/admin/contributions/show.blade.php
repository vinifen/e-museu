        ...
        <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <p class="card-text">@if($contribution->validation == 1) Sim @else Não @endif</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <strong>Id: </strong><p class="ms-3">{{ $contribution->proprietary->id }}</p>
                                ...
                                <div class="d-flex">
                                    ...
                                    <form action="{{ route('admin.proprietaries.destroy', $contribution->proprietary->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
            ...
            <div class="col-md-6">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <strong>Id: </strong><p class="ms-3">{{ $contribution->item->id }}</p>
                        <strong>Nome: </strong><p class="card-text">{{ $contribution->item->name }}</p>
                        <img src="{{ url("storage/{$contribution->item->image}") }}" class="img-thumbnail clickable-image" alt="Imagem do item" style="aspect-ratio: 1 / 1; width: 100%; max-height: 100%; object-fit: cover">
                        <strong>Descrição: </strong><p class="ms-3">{{ $contribution->item->description }}</p>
                        <strong>História: </strong><p class="card-text">{{ $contribution->item->history }}</p>
                        <strong>Detalhe: </strong><p class="ms-3">{{ $contribution->item->detail }}</p>
                        <strong>Data: </strong><p class="card-text">{{ date('d-m-Y', strtotime($contribution->item->date)) }}</p>
                        <strong>Código de Identificação: </strong><p class="ms-3">{{ $contribution->item->identification_code }}</p>
