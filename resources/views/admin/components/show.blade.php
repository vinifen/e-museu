        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card mb-3">
                    ...
                    <div class="card-body d-flex">
                        ...
                        <form action="{{ route('admin.components.destroy', $component->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="deleteComponentButton btn btn-danger"><i class="bi bi-trash-fill"></i> Excluir
                        </form>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <p class="card-text">@if($component->validation == 1) Sim @else Não @endif</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <strong>Id: </strong><p class="ms-3">{{ $component->item->id }}</p>
                        <strong>Nome: </strong><p class="card-text">{{ $component->item->name }}</p>
                        <img src="{{ url("storage/{$component->item->image}") }}" class="img-thumbnail clickable-image" alt="Imagem do item" style="aspect-ratio: 1 / 1; width: 100%; max-height: 100%; object-fit: cover">
                        <strong>Descrição: </strong><p class="ms-3">{{ $component->item->description }}</p>
                        <strong>História: </strong><p class="card-text">{{ $component->item->history }}</p>
                        <strong>Detalhe: </strong><p class="ms-3">{{ $component->item->detail }}</p>
                        <strong>Data: </strong><p class="card-text">{{ date('d-m-Y', strtotime($component->item->date)) }}</p>
                        <strong>Código de Identificação: </strong><p class="ms-3">{{ $component->item->identification_code }}</p>
            ...
            <div class="col-6">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <strong>Id: </strong><p class="ms-3">{{ $component->component->id }}</p>
                        <strong>Nome: </strong><p class="card-text">{{ $component->component->name }}</p>
                        <img src="{{ url("storage/{$component->component->image}") }}" class="img-thumbnail clickable-image" alt="Imagem do componente" style="aspect-ratio: 1 / 1; width: 100%; max-height: 100%; object-fit: cover">
                        <strong>Descrição: </strong><p class="ms-3">{{ $component->component->description }}</p>
                        <strong>História: </strong><p class="card-text">{{ $component->component->history }}</p>
                        <strong>Detalhe: </strong><p class="ms-3">{{ $component->component->detail }}</p>
                        <strong>Data: </strong><p class="card-text">{{ date('d-m-Y', strtotime($component->component->date)) }}</p>
                        <strong>Código de Identificação: </strong><p class="ms-3">{{ $component->component->identification_code }}</p>
