...
<body class="bd-light d-flex flex-column min-vh-100">
    <nav class="navbar navbar-border navbar-expand-lg navbar-light bg-light d-flex justify-content-between px-md-5 py-0">
        <div class="container-fluid">
            <div class="navbar-left d-flex py-1">
                <div class="logo-div">
                    <a class="navbar-brand fw-bold" href="/"><img src="/img/tecnolixo-logo.png" alt="" width="40" height="40"> E-MUSEU</a>
                </div>
            </div>
            <button class="button navbar-toggler p-1 nav-link" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
            </button>
            <div class="collapse navbar-collapse flex-grow-0 mt-2" id="navbarSupportedContent">
                <ul class="navbar-nav mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link p-3 fw-bold explore-button active" href="{{ route('items.index') }}"><i class="h5 bi bi-search me-2"></i>EXPLORAR</a>
                    </li>
                    <li class="nav-item">
    ...
    <div>
        <footer class="d-md-flex custom-footer px-md-5 justify-content-between fixed align-items-center  py-5 mt-2">
          ...
          <a href="/" class="col-md-4 d-flex align-items-center justify-content-center my-3 me-md-auto link-dark text-decoration-none">
